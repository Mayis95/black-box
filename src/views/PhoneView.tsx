...
export default class PhoneView extends React.Component<RouteComponentProps, State> {
    ...
    onProceedClick = () => {
        ipcRenderer.send('phone-analyse', { filePath: this.state.filePath });
    }

    public render() {
        return (
            <div>
                <h3>Analyze with phone hashes</h3>
                <p>
                    {this.state.text}
                    {this.state.filePath}
                </p>
