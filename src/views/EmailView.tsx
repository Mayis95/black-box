...
export default class EmailView extends React.Component<RouteComponentProps, State> {
    ...
    onProceedClick = () => {
        ipcRenderer.send('email-analyse', { filePath: this.state.filePath });
    }

    public render() {
        return (
            <div>
                <h3>Analyze with email hashes</h3>
                <p>
                    {this.state.text}
                    {this.state.filePath}
                </p>
